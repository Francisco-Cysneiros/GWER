...
spplot(est.mapce0.ln, zcol = 1, main = 'p-Value of the intercept coeficients for normal GWER model', col.regions = colpv(4), at = cortpv, colorkey = list(space = "right", height = 1, col.regions = colpv(4), at = cortpv), as.table = T, scales = list(draw = TRUE)) 
